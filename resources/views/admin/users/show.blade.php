            ...
            <div class="card">
                <div class="card-body border-bottom">
                    <div class="float-end dropdown ms-2">
                        <a class="text-info" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="javascript:void(0)"
                                onclick="submitDeleteForm('userShowDeleteForm_{{ $user->id }}')"> @lang('translation.delete_resource', ['resource' => __('attributes.user')])</a>
                            <form action="{{ route('users.destroy', $user->id) }}" method="POST"
                                id="userShowDeleteForm_{{ $user->id }}">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
                    ...
                    <div class="mb-4">
                        <img src="{{ asset('assets/images/users/avatar-3.jpg') }}" class="rounded-circle avatar-lg"
