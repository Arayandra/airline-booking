                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select select2 filter-input" id="origin" name="origin"
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select select2 filter-input" id="destination" name="destination"
                                    onchange="dateChanged()">
                                    <option value="" selected>@lang('translation.none')</option>
                                    @forelse ($cities as $key => $value)
                                        <option value="{{ $key }}">{{ $value }}</option>
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select select2 filter-input" id="airline" name="airline"
                                    onchange="dateChanged()">
                                    <option value="" selected>@lang('translation.none')</option>
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                                ...
                                <div class="input-daterange input-group" id="datepicker" data-date-format="yyyy-m-d"
                                    ...
                                    <input type="date" class="form-control filter-input" id="departure" name="departure"
                                        placeholder="{{ __('translation.flight.departure') }}" onchange="dateChanged()" />
                                    <input type="date" class="form-control filter-input" id="arrival" name="arrival"
                                        placeholder="{{ __('translation.flight.arrival') }}" onchange="dateChanged()" />
                                </div>
                            </div>
                        </div>
                    </div>
