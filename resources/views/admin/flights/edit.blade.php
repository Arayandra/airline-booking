...
@section('title')
    @lang('translation.edit_resource', ['resource' => __('attributes.flight')])
@endsection
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="needs-validation" novalidate action="{{ route('flights.update', $flight->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2" id="airline" name="airline_id" required>
                                            ...
                                            @foreach ($airlines as $key => $value)
                                                <option value="{{ $key }}" @selected($key === $flight->airline_id)>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2" id="plane" name="plane_id" required>
                                            ...
                                            @foreach ($planes as $key => $value)
                                                <option value="{{ $key }}" @selected($key === $flight->plane_id)>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                        <div class="valid-feedback">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-daterange input-group" id="datepicker" data-date-format="yyyy-m-d"
                                            ...
                                            <input type="date" class="form-control filter-input" id="departure"
                                                name="departure" placeholder="@lang('translation.flight.departure')" />
                                            <input type="date" class="form-control filter-input" id="arrival"
                                                name="arrival" placeholder="@lang('translation.flight.arrival')" />
                                    ...
                                    <div class="col-sm-9">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="origin"
                                                        class="col-sm-3 col-form-label">@lang('translation.flight.origin')</label>
                                                    <select class="form-control select2" id="origin" name="origin_id"
                                                        required>
                                                        <option value="">@lang('translation.none')</option>
                                                        @foreach ($airlines as $key => $value)
                                                            <option value="{{ $key }}"
                                                                @selected($key === $flight->origin_id)>{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="valid-feedback">
                                                        @lang('validation.good')
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="destination"
                                                        class="col-sm-3 col-form-label">@lang('translation.flight.destination')</label>
                                                    <select class="form-control select2" id="destination"
                                                        name="destination_id" required>
                                                        <option value="">@lang('translation.none')</option>
                                                        @foreach ($airlines as $key => $value)
                                                            <option value="{{ $key }}"
                                                                @selected($key === $flight->destination_id)>{{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="valid-feedback">
                                                        @lang('validation.good')
