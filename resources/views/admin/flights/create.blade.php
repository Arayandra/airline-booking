                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2" id="plane" name="plane_id"
                                            required></select>
                                        <div class="valid-feedback">
                                            @lang('validation.good')
                                        </div>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-daterange input-group" id="datepicker" data-date-format="yyyy-m-d"
                                            ...
                                            <input type="date" class="form-control filter-input" id="departure"
                                                name="departure" placeholder="@lang('translation.flight.departure')" required />
                                            <input type="date" class="form-control filter-input" id="arrival"
                                                name="arrival" placeholder="@lang('translation.flight.arrival')" required />
