...
@section('content')
            ...
            <div class="card overflow-hidden">
                ...
                <div class="card-body pt-0">
                    <div class="d-flex justify-content-between align-items-start">
                        <div class="">
                            <div class="mb-4">
                                <img id="avatar" src="{{ getAvatar(auth()->user()) }}" alt=""
                        ...
                        <div class="">
                            <div class="pt-4">
                                <div class="mt-4">
                                    <a href="" class="btn btn-outline-primary waves-effect waves-light btn-sm"
                                        data-bs-toggle="modal" data-bs-target=".update-profile">@lang('buttons.edit_resource', ['resource' => __('attributes.profile')])</a>
                                    <a href="" class="btn btn-outline-warning waves-effect waves-light btn-sm ms-2"
                                        data-bs-toggle="modal" data-bs-target=".update-password">@lang('buttons.edit_resource', ['resource' => __('attributes.password')])</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="needs-validation" novalidate enctype="multipart/form-data" id="update-profile">
                        ...
                        <div class="d-grid mt-3">
                            <button class="btn btn-primary waves-effect waves-light UpdateProfile"
                                data-id="{{ Auth::user()->id }}" type="submit">@lang('buttons.update')</button>
                        </div>
                    </form>
                </div>
            </div><!-- /.modal-content -->
    ...
    <div class="modal fade update-password" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="POST" id="update-password">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password-confirm" type="password" class="form-control"
                                name="new_password_confirmation" autocomplete="new_password">
